...
public class TokenService {
	...
	public String gerarToken(Usuario usuario) {
		try {
			...
			String token = JWT.create()							
					...
					.withSubject(usuario.getLogin())			// Define quem é o dono do token - Este é o atributo que retornaremos após a validação para retornar um UserDatail através do método findByXXX
					.withExpiresAt(this.geraDataExpiracao())	// Define o tempo de expiração do Token
	...
	public Instant geraDataExpiracao() {
